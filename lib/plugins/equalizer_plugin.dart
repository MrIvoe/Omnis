...
import 'package:omnis/core/audio_engine.dart' show HardwareEqBand;
...
///
/// Both models persist their gains via [AppSettings] so they survive a
/// restart — previously every band reset to flat on every launch.
///
...
class EqualizerPlugin extends MusicPlugin {
  ...
  Future<void> persistVirtualBands() =>
      AppSettings.instance.setEqualizerVirtualBands(_virtualBands);
  ...
  Future<void> persistHardwareBands() =>
      AppSettings.instance.setEqualizerHardwareBands({
  ...
  Future<void> initialize() async {
    final savedVirtual = AppSettings.instance.equalizerVirtualBands;
