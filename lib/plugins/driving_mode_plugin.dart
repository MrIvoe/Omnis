...
class DrivingModePlugin extends MusicPlugin {
  ...
  Future<bool> _ensurePermission() async {
    ...
    if (permission == LocationPermission.denied) {
      final granted = await OmnisPermissions.requestLocation();
  ...
  void _enterDrivingMode() {
    ...
    if (settings.playerLayoutId != 'car_mode') {
      _previousLayoutId = settings.playerLayoutId;
      settings.playerLayoutId = 'car_mode';
    }
  }
  ...
  void _exitDrivingMode() {
    ...
    if (previous != null && AppSettings.instance.playerLayoutId == 'car_mode') {
      AppSettings.instance.playerLayoutId = previous;
    }
  }
