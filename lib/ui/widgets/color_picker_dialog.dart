...
/// a hex-entry field for arbitrary values. Originally a private dialog
/// living only in `appearance_settings_page.dart` for the single "Accent
/// color" setting — lifted here and given [title]/hex-entry so
/// `ThemeEditorPage` can reuse it for each of `ThemeManifest`'s nine
/// color-scheme roles, which need arbitrary hex coverage the fixed
/// swatches alone can't offer.
///
